              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-4">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody id="cart-items">
                      <tr className="pb-4 border-b border-gray-line">
                        ...
                        <td className="px-1 py-4 text-center">
                          <div className="flex items-center justify-center">
                            <button className="cart-decrement border border-primary bg-primary text-white hover:bg-transparent hover:text-primary rounded-full w-10 h-10 flex items-center justify-center">
                              -
                            </button>
                            <p className="quantity text-center w-8">1</p>
                            <button className="cart-increment border border-primary bg-primary text-white hover:bg-transparent hover:text-primary rounded-full w-10 h-10 flex items-center justify-center">
                              +
                            </button>
                          </div>
                        </td>
                  ...
                  <div className="px-1 flex flex-col lg:flex-row justify-between items-center mt-10">
                    <div className="flex items-center">
                      ...
                      />
                      <button className="bg-primary text-white border border-primary hover:bg-transparent hover:text-primary rounded-r-full py-2 px-4">
                        Apply Coupon
                      </button>
                    </div>
                    <div className="mt-4 lg:mt-0 flex space-x-2">
                      <button className="bg-primary text-white border border-primary hover:bg-transparent hover:text-primary rounded-full py-2 px-4">
                        Empty Cart
                      </button>
                      <button className="bg-primary text-white border border-primary hover:bg-transparent hover:text-primary rounded-full py-2 px-4">
                        Update Cart
            ...
            <div className="md:w-1/4">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="flex justify-between mb-2">
                  ...
                  <p className="font-semibold">$21.98</p>
                </div>
                <Link
                  to="/checkout"
